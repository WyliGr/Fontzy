...
def add_font_entry(family: str, weight: int, style: str, path: Path, source_file: str, source_size: int = 0, converted_size: int = 0, variable_axes: list[dict] | None = None) -> None:
    ...
    # Store variable axes at family level if present
    if variable_axes:
        family_entry["variable_axes"] = variable_axes
    save_metadata(data)
